...
[assembly: HostingStartup(typeof(RoverLinkManager.ConfigureAuthRepository))]
    ...
    public class ConfigureAuthRepository : IHostingStartup
    {
        public void Configure(IWebHostBuilder builder) => builder
            ...
            .ConfigureAppHost(appHost => {
                ...
                authRepo.InitSchema();
                CreateUser(authRepo, "admin@email.com", "Admin User", "Password123", roles:new[]{ RoleNames.Admin });
